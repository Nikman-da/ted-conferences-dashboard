...
*Общий вид дашборда (единая страница)*  
![Общий вид дашборда TED](./images/dashboard-overview.png)

*Пример раскрытия иерархии «Страна → Конференция»*  
![Иерархия в сводной таблице](./images/drill-down.png)

*Взаимодействие с топами и детальной таблицей*  
![Перекрёстная фильтрация](./images/cross-filter.png)
